...
class UnidadedMedidaUpdateField extends StatelessWidget with HookMixin {
  const UnidadedMedidaUpdateField({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: DropdownButtonFormField(
        ...
        onChanged: (value) => updateProductUComAction(value!.name),
        items:
